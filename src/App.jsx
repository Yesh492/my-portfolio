  ...
  return (
    <div style={{ backgroundColor: '#050508', minHeight: '100vh' }}>
      ...
      <footer
        ...
        style={{ borderColor: '#16163a', backgroundColor: '#050508' }}
      >
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-3 text-center">
          ...
          {/* Divider */}
          <div style={{ width: 40, height: 1, background: 'linear-gradient(90deg, transparent, #16163a, transparent)' }} />

          {/* Credit */}
          <p className="text-xs text-[#334155]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Designed &amp; built by{' '}
            <span
              style={{
